...
- En la modal de crear nueva Convivencia (ModalAddConvivencia.astro), solicito el nombre de la convivencia una descripcion, la fecha de inicio y fin, posteriormente en seleccion de comunidades solicito seleccionar una parroquia y en comunidades disponibles deben aparecer todas las comunidades que hay en esa parroquia con las cards tal y como se muestran en este ejemplo estatico de las cards, si no hay parroquia seleccionada aparecera un mensaje 'Seleccione primero una parroquia' en el contenedor de comunidades disponibles, las comunidades con el checkbox activo permaneceran en ese contenedor de comunidades disponibles, el momento en que de click en invitar, aparecera el contenedor de lista de comunidades invitadas, entonces ahora puedo cambiar de parroquia y elegir de otra parroquia, igualmente doy a invitar y se deben ir agregando en la otra lista
- En la seccion de lista de comunidades parecera todas las comunidades con el checkbox activo de todas las parroquias, si no ha elegido comunidades este contenedor debe estar oculto, y aparecera solamente si hay comunidades con el checkbox activo.
- Por el momento seguira sin funcionar el boton de crear convivencia, trabajemos primero en la obtencion de la informacion y comunidades convocadas